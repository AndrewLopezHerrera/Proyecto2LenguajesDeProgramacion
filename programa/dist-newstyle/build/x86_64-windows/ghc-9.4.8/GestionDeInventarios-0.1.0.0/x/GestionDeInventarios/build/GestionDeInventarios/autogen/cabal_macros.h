...
/* package GestionDeInventarios-0.1.0.0 */
#ifndef VERSION_GestionDeInventarios
#define VERSION_GestionDeInventarios "0.1.0.0"
#endif /* VERSION_GestionDeInventarios */
#ifndef MIN_VERSION_GestionDeInventarios
#define MIN_VERSION_GestionDeInventarios(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GestionDeInventarios */
...
#define CURRENT_COMPONENT_ID "GestionDeInventarios-0.1.0.0-inplace-GestionDeInventarios"
